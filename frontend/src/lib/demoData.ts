...
const DEMO_RESULT_REAL: AnalysisResult = {
  ...
  agents: [
    ...
    },
    {
      ...
      detail: 'Google Vision found 3 matching web pages, all from September 2023. TinEye: first seen 2023-09-19.',
      duration: 5100,
    },
    {
      ...
      detail: 'Whisper transcription confirmed Tamil language. LLM vision analysis matches claimed location.',
      duration: 7000,
    },
  ],
};
  ...
  agents: [
    {
      ...
      status: 'done',
      score: 5,
      findings: ['Video footage is authentic', 'No manipulation detected', 'Original camera metadata intact'],
    ...
    },
    {
      ...
      detail: 'TinEye: first seen 2021-02-07. Google Vision matched 47 web pages with 3 different location claims.',
      duration: 5400,
    },
    {
      agentId: 'context-analyser',
      ...
      detail: 'LLM vision analysis: mountain terrain, snow-capped peaks visible — inconsistent with Manipur geography.',
      duration: 6800,
    },
  ],
};
  ...
  agents: [
    {
      ...
      detail: 'CrossEfficientViT: 94% AI-generated. UniversalFakeDetect: 97% fake. Consistent with diffusion model output.',
      duration: 3500,
    },
    {
      agentId: 'source-hunter',
    ...
    },
    {
      ...
      detail: 'Whisper detected synthesized speech patterns. LLM vision: buildings do not match Mumbai architecture.',
      duration: 6500,
    },
  ],
};
