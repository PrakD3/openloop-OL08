  ...
  agents: [
    {
      ...
      detail:
        "CrossEfficientViT model confidence: 97% authentic. No GAN artifacts detected.",
      duration: 3200,
    },
    {
  ...
  agents: [
    {
      ...
      detail:
        "Video is real, but context is misleading. No deepfake indicators.",
      duration: 2800,
    },
    {
      agentId: "source-hunter",
...
const DEMO_RESULT_AI_GENERATED: AnalysisResult = {
  ...
  agents: [
    ...
    },
    {
      ...
      detail:
        "TinEye: 0 matches. Google Vision: no real-world matches. EXIF metadata absent.",
      duration: 4200,
    },
    {
      agentId: "context-analyser",
...
export const MOCK_INCIDENTS: Incident[] = [
  {
    ...
    misinfoRate: 68,
    summary:
      "47 videos analysed. 68% were recycled from previous floods or AI-generated.",
  ...
  },
  {
    ...
    misinfoRate: 54,
    summary:
      "312 videos analysed during the crisis. 54% misrepresented scope or location.",
  ...
  },
  {
    ...
    misinfoRate: 22,
    summary:
      "89 videos. 78% verified authentic. Low misinformation rate for a major disaster.",
